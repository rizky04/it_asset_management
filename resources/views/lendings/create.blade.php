<x-tailadmin-app-layout :page="'lendings'">
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Catat Peminjaman</h2>
    </div>
        ...
        <form method="POST" action="{{ route('lendings.store') }}">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="borrower" value="{{ old('borrower') }}"
                ...
                <div>
                    ...
                    <input type="date" name="lend_date" value="{{ old('lend_date', now()->format('Y-m-d')) }}"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="notes" rows="3"
                              class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-300 focus:outline-hidden dark:border-gray-700 dark:text-white/90">{{ old('notes') }}</textarea>
                </div>
